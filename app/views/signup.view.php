                        ...
                        <div class="card-body p-5 text-center">
                            <div class="card-text">
                                <div class="mt-5 mb-5">
                                    ...
                                    <h2 class="h1 text-primary">Department Login</h2>
                                ...
                                <hr>
                                <div class="mb-4">
                                    <div class="text-dark ext-uppercase">Please Create Account</div>
                                </div>
                                </div>
                            ...
                            <form method="POST" class="mb-5">
                                ...
                                <div class="form-outline w-100 text-start">
                                ...
                                <?php endif; ?> 
                                            ...
                                            <label for="email">Enter Email</label>
                                        <input type="text" id="email" name="email"  class="form-control w-100" />
                                        <?php if(!empty($errors['email'])):?>
                                        <div class="text-danger"><?php echo $errors['email']?></div>
                                    <?php endif; ?>  
                                        <div class="form-outline w-100">
                                            <label for="password">Enter Password</label>
                                        <input type="text" id="password" name="password" class="form-control w-100" />
                                ...
                                <a class="mb-5" style="color:blue;" href="<?php echo ROOT?>/login"><span style="color:blue;">Already have an account login</span></a>
                            </form>
                        </div>
                    </div>
                </div>
